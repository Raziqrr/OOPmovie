...
function mainsliders(d){
  document.getElementById("tagline").innerHTML =
    d["tagline"];
  document.getElementById("mainrate").innerHTML =
    d["vote_average"].toFixed(1);
  document.getElementById("mainduration").innerHTML =
    d["runtime"] + " minutes";
...
async function search() {
  ...
  document.getElementById("status").innerHTML = "Search Results<hr>"
  ...
  stats.innerHTML = "Recommendations Based On Rating<hr>"
...
function recommendposter(array){
  ...
  for(var i=0; i<3; i++){
    ...
    link.href = "viewmovie.html?i=" + array[i].imdbID;
...
function poster(d) {
  ...
  var link = document.createElement("a");
  var newTextArea = document.createElement("div");
  link.href = "viewmovie.html?i=" + d.imdbID;
